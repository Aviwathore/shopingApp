...
import com.example.userinformation.emergency_contact_form.emergencycontactformdhbelper.EmergencyContactDataClass
...
class FormDBHelper(context: Context) :
    ...
    companion object {
        ...
        private const val TABLE_NAME1 ="GuardianInformation"
        private var KEY_ID1 = "id"
...
fun insertData(infoData: InformationFormDataClass): Long {
    ...
    fun insertGuardianData(guardianInfo : EmergencyContactDataClass):Long{
        ...
        val value = ContentValues().apply {
            ...
            put(RELATION_WITH_BANK_STAFF, guardianInfo.relation_with_bank_staff)
        ...
        val status =db.insert(TABLE_NAME1, null, value)
        db.close()
        return status
    }
