...
import com.example.userinformation.shoes.api.UserInterface
...
//            userList.add(newUser)
    ...
    private fun createNewUser(
        ...
        val retrofitBuilder = Retrofit.Builder().addConverterFactory(GsonConverterFactory.create()).baseUrl(BASE_URL).build().create(UserInterface::class.java)
