...
class HomeAdaptor(
    private var homeList: ArrayList<HomeToDo>,
    private var deleteItem: OnDeleteItemClickListener
...
//    }
    ...
    class ViewHolder(view: View, private val deleteItem: OnDeleteItemClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeAdaptor.ViewHolder {
        ...
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.home_recycle_layout, parent, false)
