...
//        }
    ...
    private fun topAppBarItem() {
        topAppBar.setOnMenuItemClickListener{
            val favouriteClothFragment = FavouriteClothFragment()
            when(it.itemId){
                R.id.nav_fav -> {
                    supportFragmentManager.beginTransaction().add(R.id.cloth_fragment, favouriteClothFragment).commit()
                    true
                }
    ...
    fun onCloth(view: View) {
        if (view.id == R.id.btnCloths) {
            ...
            supportFragmentManager.beginTransaction()
                .add(R.id.cloth_fragment, fragment, "Cloth Fragment").commit()
        }
    }
        ...
        bottomNav.setOnItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.navigation_profile -> {
                    val fragment = ClothFragment()
                    supportFragmentManager.beginTransaction().replace(R.id.cloth_fragment, fragment).commit()
                    true
                }

                R.id.navigation_fav -> {
                    val favFragment = FavouriteClothFragment()
                    supportFragmentManager.beginTransaction().add(R.id.cloth_fragment, favFragment).commit()
                    true
                }
